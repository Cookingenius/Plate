...
var recipe = angular.module("recipes.details", modules);
...
//  };
  ...
  constructor(
    private $scope: app.IScope,
    private $rootScope: app.IRootScope,
    private recipeService: recipes.IRecipeService
   ) {
    $scope.vm = this;

    recipeService.getById(39).then((recipe: api.IRecipe) => {
      this.recipe = recipe;
      $rootScope.pageTitle = this.recipe.name;
    });
  }
}
